...
TYPES  : BEGIN OF TY_VBPA,
         ...
         END OF TY_VBPA,
         TY_T_VBPA TYPE HASHED TABLE OF TY_VBPA WITH UNIQUE KEY VBELN,
         BEGIN OF TY_BSIDR,
         ...
         END OF TY_BSIDR,
         TY_T_BSIDR TYPE HASHED TABLE OF TY_BSIDR WITH UNIQUE KEY BUKRS BELNR GJAHR REBZG.
DATA : IT_VBPA     TYPE TY_T_VBPA,
       WA_VBPA     TYPE TY_VBPA,
       IT_BSIDR    TYPE TY_T_BSIDR,
